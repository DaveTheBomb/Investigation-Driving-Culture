...
class BasePredictor:
    ...
    def __call__(self, source=None, model=None):
        ...
        for batch in self.dataset:
            ...
            # Calculate and write processing delay to a text file
            processing_delay_ms = self.dt[1].dt * 1E3  # Processing delay in milliseconds
            with open(os.path.join("Process_Delay.txt"), "w") as delay_file:
                 delay_file.write(f"{processing_delay_ms:.1f}\n")
